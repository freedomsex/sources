...
<template>
  <div v-if="enabled && regular">
    ...
    <div class="container visible-xs-block" v-else-if="width"></div>
    <!-- /build -->
  </div>
</template>
