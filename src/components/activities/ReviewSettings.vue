...
<template>
  <ActivityActions caption="Отзыв" type="wrapped" @close="$emit('close')">
    ...
    <div class="context-info">
      Текст отзыва будет доступен для участников сообщества, Модераторов и Администраторов сообщества. Конфиденциальную информацию отправьте непосредственно разработчикам на почту.
    </div>
